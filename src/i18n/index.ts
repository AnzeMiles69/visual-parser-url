...
const ru: Dict = {
  ...
  'status.pageObject': 'Page Object: {name}',

  'msg.scanReady': 'Скан готов: {count} элементов{warnings}',
  ...
  'panel.header': 'Каталог элементов · клик по строке подсвечивает область на скриншоте',
...
const en: Dict = {
  ...
  'msg.scanReady': 'Scan complete: {count} elements{warnings}',
  ...
  'panel.header': 'Element catalog · click a row to highlight it on the screenshot',
